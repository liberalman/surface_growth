...
#include "surface_growth.h"		// Contains necessary CUDA and other headers and wrappers.

int ReadInputFile(char *szInpFile);
...
MATERIAL Material [] = 
{
	...
	"Cu", 2.556162, 1.554485,  22.150141,  7.669911,  4.090619,  0.327584, 0.468735,
	...
	// silver Ag(1)
	// szName,	re,	       fe,        rhoe,        alpha,     beta,      A,       B,
	"Ag", 2.891814, 1.106232,  15.539255,  7.944536,  4.237086,  0.266074, 0.386272,
	// kappa,   lambda,    Fn[0],     Fn[1],       Fn[2],     Fn[3], 
	...
	// gold Au(2)
	// szName,	re,	       fe,        rhoe,        alpha,     beta,      A,       B,
	"Au", 2.885034, 1.529021,  21.319637,  8.086176,  4.312627,  0.230728, 0.336695,
	// kappa,   lambda,    Fn[0],     Fn[1],       Fn[2],     Fn[3], 
	...
	// nickel Ni(3)
	// szName,	re,	       fe,        rhoe,        alpha,     beta,      A,       B,
	"Ni", 2.488746, 2.007018,  27.984706,  8.029633,  4.282471,  0.439664, 0.632771,
	// kappa,   lambda,    Fn[0],     Fn[1],       Fn[2],     Fn[3], 
	...
	// aluminium Al(4)
	// szName,	re,	       fe,        rhoe,        alpha,     beta,      A,       B,
	"Al", 2.886166, 1.392302,  20.226537,  6.942419,  3.702623,  0.251519, 0.313394,
	// kappa,   lambda,    Fn[0],     Fn[1],       Fn[2],     Fn[3], 
	...
	// lead Pb(5)
	// szName,	re,	       fe,        rhoe,        alpha,     beta,      A,       B,
	"Pb", 3.499723, 0.647872,  8.906840,   8.468412,  4.516486,  0.134878, 0.203093,
	// kappa,   lambda,    Fn[0],     Fn[1],       Fn[2],     Fn[3], 
